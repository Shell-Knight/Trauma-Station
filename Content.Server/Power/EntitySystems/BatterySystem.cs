...
{
    [Dependency] private readonly SharedContainerSystem _containers = default!; // Goob
    [Dependency] private readonly IGameTiming _timing = default!;

    private EntityQuery<EmpDisabledComponent> _disabledQuery; // Goob

    public override void Initialize()
    {
        base.Initialize();

        _disabledQuery = GetEntityQuery<EmpDisabledComponent>(); // Goob
